...
sub Read {
    ...
    my $caption = __("Initializing slp-server Configuration");
...
sub Write {
    ...
    # SlpServer read dialog caption
    my $caption = __("Saving slp-server Configuration");
